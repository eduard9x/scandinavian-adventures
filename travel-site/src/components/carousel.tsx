...
const Carousel = ({items}: Destination[]) => {
  return (
    <div className='w-screen -m-5 pl-5 py-6 bg-gray-efed'>
      <h2 className='carousel-title pb-3 text-dark-222'>Adventure awaits out
        there</h2>
      <p className='carousel-subtitle mb-10 text-dark-222'>Get out and
        expreience Scandinavian way of living</p>

      <ul className='m-0 p-0 list-none flex overflow-x-scroll'>
        {items.map((data: Destination) => (
          <li className='pr-5'>
            <div className='bg-black width-275'>
